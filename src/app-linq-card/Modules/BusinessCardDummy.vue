<template>
    <div class="business-card-wrapper">
      <!-- Controls container with color options and theme toggle -->
      ...
      <div class="card-container">
        <div :class="['card', { flipped: isFlipped }]" @click="flipCard">
      ...
      flipCard(e) {
        ...
        if (!e.target.closest('.icon-button')) {
          ...
          if (this.$refs.flipSound) {
            this.$refs.flipSound.currentTime = 0; // Reset sound
  ...
  /* Add a wrapper div to ensure the component takes full height and has black bg */
  ...
  .social-links {
      ...
      gap: 15px;
      margin: 15px 0;
      padding: 10px 15px; /* Added left padding */
